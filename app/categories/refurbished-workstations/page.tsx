...
export async function generateMetadata({ searchParams }: CategoryPageProps): Promise<Metadata> {
  ...
  return constructMetadata({
    title: "Refurbished Workstations for Business & Rendering",
    description: "High-end enterprise refurbished workstations with professional graphics and Xeon processors. Certified commercial hardware with 1-year warranty.",
    path: "/categories/refurbished-workstations",
    canonical: "/categories/refurbished-workstations",
    keywords: [
      "refurbished workstations",
      "used rendering PC",
      "enterprise workstations",
      "refurbished Xeon computers",
      "Comsri workstations"
    ],
    noIndex,
  });
...
export default async function RefurbishedWorkstationsPage({ searchParams }: CategoryPageProps) {
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        "@type": "ListItem",
        "position": 3,
        "name": "Refurbished Workstations",
        "item": "https://comsri.com/categories/refurbished-workstations"
      }
    ]
  };
  ...
  const productSchemaList = {
    "@context": "https://schema.org",
    "@type": "ItemList",
    "name": "Refurbished Workstations Catalog",
    "description": "Certified high-end refurbished workstations in India.",
        ...
        <div className="max-w-[1600px] mx-auto relative z-10">
          <div className="max-w-2xl">
            ...
            <h1 className="text-3xl md:text-5xl font-medium tracking-tight leading-none mb-3">
              {activeCategoryObject ? activeCategoryObject.name : "Refurbished Workstations"}
            </h1>
            <p className="text-sm md:text-base text-slate-300 leading-relaxed max-w-xl">
              {activeCategoryObject?.description
                ? activeCategoryObject.description
                : "Explore our collection of commercial-grade certified refurbished workstations. Subjected to extensive multithreaded diagnostics with 1-year coverage warranty."
              }
            </p>
              ...
              {[
                ...
                <Link
                  ...
                  className={`text-xs font-semibold px-3.5 py-1.5 rounded-full transition-all ${
                    cat.path === "/categories/refurbished-workstations"
